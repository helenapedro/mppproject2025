...
public class FindAllocationsByEmployeeDao implements Dao<EmployeeProject> {
    private final int employeeId;
    private final List<EmployeeProject> out = new ArrayList<>();

    public FindAllocationsByEmployeeDao(int employeeId){
        this.employeeId = employeeId;
    }

    @Override public String getSql(){
        return "SELECT * FROM employee_project WHERE employee_id=?";
    }
    ...
    @Override public List<EmployeeProject> getResults(){
        return out;
    }
}